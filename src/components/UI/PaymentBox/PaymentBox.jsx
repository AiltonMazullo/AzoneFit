  ...
  return (
    <div className={styles.BoxList}>
      <div className={styles.BoxListItem}>
        ...
        <div id="paypal-container-basic" className={styles.paypalContainer}></div>
      </div>

      <div className={styles.BoxListItem}>
        <img src={premiumIcon} alt="Premium Plan" className={styles.serviceIcon} />
        <h4 className={styles.headerTextBlue}>PREMIUM PLAN</h4>
        <div id="paypal-container-premium" className={styles.paypalContainer}></div>
      </div>

      <div className={styles.BoxListItem}>
        <img src={eliteIcon} alt="Elite Plan" className={styles.serviceIcon} />
        <h4 className={styles.headerTextBlue}>ELITE PLAN</h4>
        <div id="paypal-container-elite" className={styles.paypalContainer}></div>
      </div>

      <div className={styles.BoxListItem}>
        <img src={ChallengeIcon} alt="Challenge Plan" className={styles.serviceIcon} />
        <h4 className={styles.headerTextBlue}>CHALLENGE</h4>
        <div id="paypal-container-challenge" className={styles.paypalContainer}></div>
      </div>
    </div>
  );
};
